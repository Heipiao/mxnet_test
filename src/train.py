...
parser.add_argument('--network', type=str, default='inception',
...
parser.add_argument('--finetune-from', type=str, default="../model/Inception-BN-0126",
...
# network
import importlib
net = importlib.import_module('' + args.network).get_symbol(args.num_classes, args.dataset)
